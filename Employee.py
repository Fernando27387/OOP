class Employee:
    def __init__(self, name, hourly_rate, hours_worked, experience):
        self.name = name
    ...
    def calculate_salary(self):
        if self.experience < 8:
            ...
            print("You did not specify what to do if the user inputs a number grater than 8 or less than 15")
